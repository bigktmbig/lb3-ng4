...
export class UserApi extends BaseLoopBackApi {
   ...
   * </em>
   */
  public findByIdAccessTokens(id: any, options: any = undefined, fk: any) {
   ...
   */
  public destroyByIdAccessTokens(id: any, options: any = undefined, fk: any) {
   ...
   * </em>
   */
  public updateByIdAccessTokens(id: any, options: any = undefined, fk: any, data: any = undefined) {
   ...
   * </em>
   */
  public getAccessTokens(id: any, options: any = undefined, filter: LoopBackFilter = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * </em>
   */
  public createAccessTokens(id: any, options: any = undefined, data: any = undefined) {
   ...
   * This method returns no data.
   */
  public deleteAccessTokens(id: any, options: any = undefined, where: any = undefined) {
    let method: string = "DELETE";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/accessTokens";
    let routeParams: any = {
   ...
   *  - `count` – `{number}` - 
   */
  public countAccessTokens(id: any, options: any = undefined, where: any = undefined) {
    let method: string = "GET";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
   ...
   * This method returns no data.
   */
  public changePassword(id: any = undefined, oldPassword: any, newPassword: any, options: any = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    ...
    let urlParams: any = {};
    if (oldPassword) urlParams.oldPassword = oldPassword;
    if (newPassword) urlParams.newPassword = newPassword;
    let result = this.request(method, url, routeParams, urlParams, postBody);
    return result;
  }
   ...
   * </em>
   */
  public createManyAccessTokens(id: any, options: any = undefined, data: Array<any> = undefined) {
    let method: string = "POST";
    let url: string = LoopBackConfig.getPath() + "/" + LoopBackConfig.getApiVersion() +
    "/Users/:id/accessTokens";
    let routeParams: any = {
